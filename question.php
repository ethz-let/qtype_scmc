...
class qtype_scmc_question extends question_graded_automatically_with_countback {
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('oneanswerperrow', 'qtype_scmc');
    }
    ...
    public function check_file_access($qa, $options, $component, $filearea, $args, $forcedownload) {
        if ($component == 'qtype_scmc' && $filearea == 'optiontext') {
            return true;
        } else if ($component == 'qtype_scmc' && $filearea == 'feedbacktext') {
            return true;
