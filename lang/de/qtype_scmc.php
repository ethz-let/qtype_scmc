...
$string['pluginname_help'] = 'SC/MC-Fragen bestehen aus einem Item-Stamm und vier zugehörigen Wahlantworten. Jede Wahlantwort muss als «richtig» oder «falsch» bewertet werden.';
...
$string['pluginnamesummary'] = 'In SC/MC-Fragen müssen genau vier Wahlantworten als «richtig» oder «falsch» bewertet werden.';
...
$string['scoringmethod_help'] = '&laquo;Nur bei der Auswahl „mehrere Antworten erlauben“ gibt es zwei verschiedene Bewertungsmethoden.&raquo;<br /><strong>Teilpunkte:</strong> Bei der Auswahl „Teilpunkte“ erhalten Kandidaten/innen Teilpunkte für jede richtige Bewertung.<br /><strong>MC1/0:</strong> Bei der Auswahl „MC1/0“ erhalten Kandidaten die volle Punktzahl, wenn alle Wahlantworten richtig bewertet wurden und null Punkte sonst.';
