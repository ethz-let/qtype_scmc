...
$string['pluginname_help'] = 'Teilnehmer/innen bewerten zur Beantwortung einer Fragestellung mehrere Wahlantworten aus einer Liste aus. Es stehen zwei verschiedene Formate zur Verfügung: Einfachwahlaufgaben („Single-Choice“) sowie Mehrfachwahlaufgaben („Multiple-Choice“).';
...
$string['numberofcolumns_help'] = '<strong>Nur eine Antwort erlauben (empfohlen)</strong>: Verwenden Sie diese Einstellung für Einfachwahlaufgaben. Eine Option muss als die einzig richtige oder beste Antwort identifiziert werden („eine beste Antwort“).<br /><br /><strong>Mehrere Antworten erlauben</strong>: Verwenden Sie diese Einstellung für Mehrfachwahlaufgaben. Jede Option muss anhand der gesetzten Kriterien, z.B. wahr/falsch eingeschätzt werden („mehrfach wahr/falsch“).';
$string['numberofrows_help'] = 'Wählen Sie die Anzahl Wahlantworten Sie einfügen möchten. Wenn Sie auf eine kleinere Anzahl Wahlantworten wechseln, werden bereits ausgefüllte Wahlantworten gelöscht, sobald die Frage gespeichert wird.';
