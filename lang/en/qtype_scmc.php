...
$string['pluginname_help'] = 'SC/MC questions consist of an item stem and four corresponding options. For each option students have to decide whether it is "true" or "false".';
...
$string['pluginnamesummary'] = 'In SC/MC questions exactly four options have to be correctly rated as "true" or "false".';
