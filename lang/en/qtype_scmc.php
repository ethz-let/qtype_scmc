...
$string['pluginname_help'] = 'In response to a question (that may include a image) the respondent chooses from multiple options. There are two types of multiple choice questions - one answer and multiple answer.';
...
$string['pluginnamesummary'] = 'Allows the selection of a single or multiple option(s) from a pre-defined list.';
