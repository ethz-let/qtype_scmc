...
$string['configshuffleanswers'] = 'Default setting for option shuffling in SC/MC questions.';
...
$string['numberofcolumns_help'] = '<strong>One answer only</strong> (recommended): use this setting for Single Choice items. One option must be identified as the only correct or best answer ("one best answer").<br /><strong>Multiple answers</strong>: use this setting for Multiple Choice items. All options must be judged individually according to the criteria provided, e.g. true/false ("multiple true-false").';
...
$string['privacy:metadata'] = 'The SC/MC question type plugin does not store any personal data.';